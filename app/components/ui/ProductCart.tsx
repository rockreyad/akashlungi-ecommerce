...
const ProductCart = () => {
  return (
    ...
    >
      <div className="p-2 mx-auto mt-12">
          ...
          <table className="w-full shadow-inner">
            <thead>
              <tr className="bg-gray-100">
                <th className="px-1 md:px-2 py-1 md:py-2 font-semibold text-sm md:text-base md:font-bold whitespace-nowrap">
                  Image
                </th>
                <th className="px-1 md:px-2 py-1 md:py-2 font-semibold text-sm md:text-base md:font-bold whitespace-nowrap">
                  Product
                ...
                <td>
                  <div className="flex justify-center">
                    <img
                      ...
                      className="object-cover h-10 w-10 md:w-20 md:h-20 lg:w-28 lg:h-28 rounded-2xl"
                      alt="image"
                    />
                  </div>
                </td>
                <td className="p-2 px-2 text-center whitespace-nowrap">
